...
//            if (boxCollider.bounds.min.x+ horizExtent > dragVector.x) dragVector.x = boxCollider.bounds.min.x + horizExtent;
//            if (boxCollider.bounds.max.x- horizExtent < dragVector.x) dragVector.x = boxCollider.bounds.max.x - horizExtent;
//            if (boxCollider.bounds.min.y+ vertExtent > dragVector.y) dragVector.y = boxCollider.bounds.min.y + vertExtent;
//            if (boxCollider.bounds.max.y- vertExtent < dragVector.y) dragVector.y = boxCollider.bounds.max.y - vertExtent;
